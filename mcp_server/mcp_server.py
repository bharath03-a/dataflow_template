...
def validate_template_dir(template_dir: Path) -> Optional[str]:
    """
    ...
    if not template_dir.exists():
        return (
            ...
            "Please ensure template_files directory exists or set DATAFLOW_TEMPLATE_DIR environment variable."
        )
...
def validate_target_path(target_path: Path) -> Optional[str]:
    """
